...
def atari_run(_run, _config, _log):
...
def run_sequential(args, logger):
    ...
    while runner.t_env <= args.t_max:
        ...
        #print(episode_batch.max_seq_length) #유동적버퍼확인용
        #print(episode_batch["obs"].shape) #유동적버퍼확인용
        ...
        if buffer.can_sample(args.batch_size):
            ...
            #print("ss",episode_sample.max_seq_length) #유동적버퍼확인용
