...
#from components.s_episode_buffer import ReplayBuffer
from components.transforms import OneHot


def origin_atari_run(_run, _config, _log):
...
def evaluate_sequential(args, runner):
    ...
    for _ in range(args.test_nepisode):
        ...
        buffer.append(episode_batch)

    if args.save_replay:
        runner.save_replay(buffer)
...
def run_sequential(args, logger):
    ...
    print("obs_shape", env_info["obs_shape"])
    ...
    scheme = {
        ...
        "next_obs": {"vshape": args.obs_shape, "group": "agents"},
    }
    groups = {
    ...
    buffer = ReplayBuffer(scheme, groups, args.buffer_size, 1,
    ...
    while runner.t_env <= args.t_max:
        ...
        for _, item in enumerate(episode_batch):
            buffer.insert_episode_batch(item)
